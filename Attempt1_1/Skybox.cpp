...
void Skybox::Render(float * matrix)
{
	...
	glTexCoord2f(1.0f, 0.0f); glVertex3f(120.0f, -120.0f, -120.0f);  // Bottom Right Of The Texture and Quad
	glTexCoord2f(1.0f, 1.0f); glVertex3f(120.0f, 120.0f, -120.0f);  // Top Right Of The Texture and Quad
	glTexCoord2f(0.0f, 1.0f); glVertex3f(120.0f, 120.0f, 120.0f);  // Top Left Of The Texture and Quad
	glTexCoord2f(0.0f, 0.0f); glVertex3f(120.0f, -120.0f, 120.0f);  // Bottom Left Of The Texture and Quad
	glEnd();
