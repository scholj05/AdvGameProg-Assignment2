...
private:
	...
	HeightMap::RandomNumber data_NumberGen[3] = { HeightMap::RandomNumber::normalDistribution, HeightMap::RandomNumber::logNormalDistribution, HeightMap::RandomNumber::uniformDistribution};
	...
	float data_Range[11] = { 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 10.0f, 15.0f, 20.0f, 50.0f, 75.0f, 100.0f };
